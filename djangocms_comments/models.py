...
class Comment(models.Model):
    ...
    moderated_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, blank=True, null=True)
    ...
    def __str__(self):
        return '[{}] {}'.format(self.page, truncatechars(self.body, 40))
...
class AnonymousAuthor(models.Model):
    ...
    comments = GenericRelation(
        Comment, object_id_field='author_id', content_type_field='author_type',
        **{'related_query_name' if django.VERSION >= (1, 7) else 'related_name': 'anonymous_authors'}
    )
